...
window.hotels = [
    ...
    new Hotel(1, 'São Paulo Inn', 155, 4.8, [], destinations[0], 'Hotel São Paulo Inn encontra-se em São Paulo. Oferece wi-fi grátis nas áreas comuns, serviço de massagem e serviço de manobrista, assim como campo de golfe.', '0.jpg'),
    new Hotel(2, 'Savoy Othon', 230, 4.5, [], destinations[1], 'O Savoy Othon está localizado a 400 m da praia de Copacabana, uma das mais famosas do Rio de Janeiro. Situado a 500 m da estação de metrô Cantagalo, o que favorece a mobilidade para outras zonas da cidade e pontos turísticos, o hotel oferece café da manhã já incluído na diária. O Aeroporto Santos Dumont está a 11 km da propriedade.', '0.jpg'),
    new Hotel(3, 'Fiesta Bahia Hotel', 269, 4.9, [], destinations[2], 'O Fiesta Bahia Hotel, em Salvador, está a 1 km do Parque da Cidade, a 12 km do Pelourinho e do Mercado Modelo e a 25 km do Aeroporto Internacional de Salvador. Em frente à 5 shoppings, o hotel dispõe de piscina ao ar livre semiolímpica, Wi-Fi grátis e centro de convenções para 5.300 pessoas. ', '0.jpg'),
    new Hotel(4, 'Hotel Praia do Sol', 329, 4.2, [], destinations[3], 'O Hotel Praia do Sol, que oferece acesso direto à Praia do Sul, possui piscina com toboágua e solário, loja de conveniência 24h e ampla área verde, fica a 4 km do centro de Ilhéus. O Aeroporto de Ilhéus – Jorge Amado está a 2 km.', '0.jpg'),
    new Hotel(5, 'Hotel Senac Ilha do Boi', 263, 4.3, [], destinations[4], 'O Senac Ilha do Boi está localizado em Vitória, em frente à Praia da Jurema, com acesso direto ao mar. Dispõe de piscina e estacionamento privativo. O Aeroporto de Vitória - Eurico Salles encontra-se a 10 km do local.', '0.jpg'),
    new Hotel(6, 'Hotel Ponta Verde Maceió', 453, 4.1, [], destinations[5], 'Situado em Maceió, à beira-mar, em frente à Praia de Ponta Verde, o Hotel Ponta Verde Maceió oferece piscina adulto e infantil com área de lazer, bem como Wi-Fi gratuito e recepção 24h.', '0.jpg'),
];
